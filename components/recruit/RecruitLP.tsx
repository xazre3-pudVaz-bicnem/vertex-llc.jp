...
const jobData = [
  { label: "募集職種", value: "軽貨物配送ドライバー" },
  { label: "雇用形態", value: "業務委託契約" },
  { label: "仕事内容", value: "ラストワンマイル配送・企業配送・スポット配送・チャーター配送など" },
  { label: "勤務地",   value: "東京都内および近郊（八王子市拠点）" },
  { label: "応募資格", value: "普通自動車免許（AT限定可）／未経験歓迎" },
  { label: "勤務時間", value: "案件により異なる（相談可）" },
  { label: "休日",     value: "案件により異なる（相談可）" },
];

const faq = [
  { q: "東京での軽貨物ドライバー求人ですが、未経験でも応募できますか？", a: "はい、未経験歓迎です。東京・八王子エリアを中心に、一から丁寧にサポートしますのでご安心ください。" },
  { q: "車両は必要ですか？",   a: "車両リース制度がありますので、車をお持ちでない方でも安心して始められます！" },
  { q: "業務委託契約の場合、稼働日・時間は自由ですか？", a: "基本的に相談に応じます。業務委託契約のため、ご自身のペースで自由度の高い働き方が可能です。" },
  { q: "軽貨物ドライバーとして高収入は期待できますか？", a: "走った分だけ報酬が増える仕組みです。努力と稼働量が収入に直結するため、高収入を目指せます。" },
];
    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            合同会社VERTEXでは、東京都内で活躍できる軽貨物配送ドライバー（業務委託）を募集しています。
            未経験歓迎・高収入可能・自由な働き方。一緒に物流業界を変えていきましょう。
          </motion.p>
